...
The response is already in English. Here's the same guide with minor improvements:

# Guide: Enable amdgpu on Void Linux

## 🚀 **Steps to enable amdgpu:**
